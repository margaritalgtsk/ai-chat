...
If the user refers to "this app", "this product", or asks how something here works — always use knowledgeSearch, not webSearch. Use queries like "tech stack architecture" or "how this app works", NOT "app development" (which returns company service info instead).
